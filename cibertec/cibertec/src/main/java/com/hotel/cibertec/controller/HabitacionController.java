...
public class HabitacionController {
    ...
    public ResponseEntity<ApiResponse<?>> registrar(@Valid @RequestBody HabitacionDto dto) {
        try {
    ...
    public ResponseEntity<ApiResponse<?>> actualizar(@PathVariable Integer id, @Valid @RequestBody HabitacionDto dto) {
        try {
