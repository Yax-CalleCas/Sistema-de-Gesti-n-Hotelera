...
public class ProductoController {
    ...
    public ResponseEntity<ApiResponse<?>> registrar(@Valid @RequestBody ProductoDto dto) {
        try {
    ...
    public ResponseEntity<ApiResponse<?>> actualizar(@PathVariable Integer id, @Valid @RequestBody ProductoDto dto) {
        try {
